...
import AreaChartComponent2 from "@/components/areaChart2";
...
const Page = () => {
  ...
  const [rash, setrash] = useState(0);

  const analyticsData = {
    averageVelocity: 65.5,
    frontWarnings: rash,
    rearWarnings: rear,
    averageWarnings: (rash + rear)/2,
  };
  ...
  const fetchDrowsinessValue = async () => {
    try {
      ...
      setrear(data.rear['2025-02-09']);
      setrash(data.rash['2025-02-08']);

      console.log("Data fetched1:", data.rear['2025-02-09']);
      console.log("Data fetched2:", data.rash['2025-02-08']);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          />
           ...
           {/* <div className="p-7 border rounded-2xl flex items-center justify-between bg-gradient-to-r
              ...
              <div>
                <h2 className="text-sm">Front Warnings</h2>
                <h2 className="font-bold text-2xl">
                {analyticsData.frontWarnings}
                </h2>
              </div>
             <MdWarning className="bg-transparent p-3 h-12 w-12 rounded-full text-white" />
           </div> */}
          ...
          <KPICard
            ...
            value={`${analyticsData.averageVelocity} mph`}
            icon={BiTachometer}
